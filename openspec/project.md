...
- **The Interface (Hybrid):**
    - **Web App:** The "Board Room." Used for high-level planning, logic deconstruction, and viewing the "Truth" (Knowledge Base). Built with lightweight **HTMX** for dynamic partial updates.
